var map;
      ...
      function initMap() {
        map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 21.5645, lng: 72.9289},
          zoom: 11,
          mapTypeControl: false
        });
        var locations = [
          {title: 'Anand', location: {lat: 22.5645, lng: 72.9289},subset: [{title:'Madhuban Resort',loc: {lat: 22.5393, lng:72.9414}},{title:'Shashtri Ground',loc:{lat: 22.2953,lng:70.7997}}]},
          {title: 'Gandhidham', location: {lat: 23.0753, lng: 70.1337},subset: [{title:'Radisson Hotel Kandla',loc: {lat: 23.0856, lng:70.1083}},{title:'Hill Garden',loc:{lat: 23.2381,lng:69.6422}}]},
          {title: 'Mumbai', location: {lat: 19.0760, lng: 72.8777},subset: [{title:'Hotel Taj',loc: {lat: 18.9217, lng:72.8330}},{title:'Adlabs Imagica',loc:{lat: 20.0000,lng:76.0000}}]},
          {title: 'Surat', location: {lat: 21.1702, lng: 72.8311},subset: [{title:'The Gateway Hotel',loc: {lat: 21.1773, lng:72.7890}},{title:'Dutch Garden',loc:{lat: 21.1992,lng:72.8155}}]},
          {title: 'Ahmedabad', location: {lat: 23.0225, lng: 72.5714},subset: [{title:'TGB',loc: {lat: 23.0425, lng:72.5154}},{title:'Riverfront',loc:{lat: 23.0080,lng:72.5716}}]}
        ];
      ...
      function populateInfoWindow(marker, infowindow) {
        if (infowindow.marker != marker) {
          ...
          /*infowindow.setContent('<div id="form-container">' + 
            '<h2>'+marker.title +'  :)'+'</h2>'+'<br/>'+'<h3 id="wikipedia-links" >'+'Related Wikipedia link:'
          +url+'</h3>'+'<h5>'+'Location is:'+'<br/>'+marker.position+'</h5>'+ '</div>');*/
